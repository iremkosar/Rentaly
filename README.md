🚗 Rentaly - Akıllı Araç Kiralama Platformu

Rentaly, modern web teknolojileri ve yapay zeka destekli çözümler kullanılarak geliştirilmiş, kullanıcı odaklı ve dinamik bir araç kiralama sistemidir. Proje; güçlü admin paneli, otomasyon süreçleri ve veri odaklı yönetim yaklaşımı ile gerçek dünya ihtiyaçlarına çözüm sunar.
...
Admin rezervasyonu değerlendirir
Onay / red işlemi gerçekleştirilir
Onay durumunda kullanıcıya otomatik e-posta gönderilir
